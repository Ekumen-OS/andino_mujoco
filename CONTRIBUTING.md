...
## Contributing to andino_mujoco

The following is a set of guidelines for contributing to the `andino_mujoco` project.
...
* **Which version of andino_mujoco are you using**?
* **What's the name and version of the OS you're using**?
* **Are you running andino_mujoco using the provided docker container?**
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/andino_mujoco/issues?q=is%3Aissue) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
* **Specify which version of andino_mujoco you're using.**
...
#. **Fork the andino_mujoco package** you want to contribute to. This will create
